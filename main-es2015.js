...
let MovieComponent = class MovieComponent {
    constructor(router, _movieService) {
        this.router = router;
...
let MoviesComponent = class MoviesComponent {
    constructor(_movieService) {
        this._movieService = _movieService;
        this._movieService.getPopular().subscribe(res => { this.popularList = res; });
...
let MovieService = class MovieService {
    ...
    getPopular() {
        return this._http.get('https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=4d29b35a33734de1e1f8e9200569f1bf')
            .map((res) => res);
    }
    getInTheaters() {
        return this._http.get('https://api.themoviedb.org/3/discover/movie?primary_release_date.gte=2016-09-26&primary_release_date.lte=2016-10-30&api_key=' + this.apikey)
            .map((res) => res);
    }
...
module.exports = __webpack_require__(/*! C:\Users\Kanishk\Desktop\movief2\src\main.ts */"./src/main.ts");
